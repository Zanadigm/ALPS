...
if (isset($_GET['id']) && $_GET['id'] > 0) {
    $qry = $conn->query("SELECT qo.*, c.* from `quotation_list` qo inner join `client_list` c on qo.client_id = c.id where qo.id = '{$_GET['id']}' ");
    if ($qry->num_rows > 0) {
...
<div class="card card-outline card-info">
    ...
    <div class="card-body" id="out_print">
        <div class="row">
            ...
            <div class="col-3 d-flex align-items-center">
                <div>
                    <p class="m-0" style="font-weight: bold; text-transform: uppercase"><?php echo ('Client Info') ?></p>
            ...
            <div class="col-3 d-flex align-items-center">
                <div>
                    <H2>QUOTATION</H2>
                    <p class="m-0">QO No : <?php echo ($qo_no) ?></p>
                    <p class="m-0">Date : <?php echo date("Y-m-d", strtotime($date_created)) ?></p>
                    <p class="m-0">Valide till : <?php echo date("Y-m-d", strtotime($validity)) ?></p>
                    <p class="m-0">Prepared By : Remmy Amya</p>
                </div>
            </div>
                    ...
                    <tfoot>
                        <tr class="bg-lightblue">
                            ...
                            <tr>
                                ...
                                <th class="p-1 text-right" id="total"><?php echo isset($tax_amount) ? number_format($sub_total + $labor_amount + $tax_amount - $discount_amount ) : 0 ?></th>
                            </tr>
                        </tr>
                    </tfoot>
                </table>
