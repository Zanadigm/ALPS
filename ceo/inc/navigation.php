...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary bg-navy elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>ceo" class="brand-link bg-primary text-sm">
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>ceo/?page=store_requisitions" class="nav-link nav-store_requisitions">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>ceo/?page=deliveries" class="nav-link nav-deliveries">
                        <i class="nav-icon fas fa-truck-loading"></i>
                        <p>
                          Deliveries
                        </p>
