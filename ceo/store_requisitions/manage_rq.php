		...
		<form action="" id="po-form">
			...
			<div class="row">
			    <div class="col-md-4 form-group">
					...
					<input type="text" class="form-control form-control-sm rounded-0" id="deliver_to" name="deliver_to" readonly value="<?php echo isset($deliver_to) ? $deliver_to : '' ?>">
				</div>

				<div class="col-md-4 form-group">
					<label for="department_name">Department Name <span class="po_err_msg text-danger"></span></label>
					<input type="text" class="form-control form-control-sm rounded-0" id="department_name" name="department_name" readonly value="<?php echo isset($department_name) ? $department_name : '' ?>">
				</div>

				<div class="col-md-4 form-group">
					<label for="building_name">Building Name & Room Number<span class="po_err_msg text-danger"></span></label>
					<input type="text" class="form-control form-control-sm rounded-0" id="building_name" name="building_name" readonly value="<?php echo isset($building_name) ? $building_name : '' ?>">
				</div>
				...
				<div class="col-md-6 form-group">
					...
					<input type="text" class="form-control form-control-sm rounded-0" id="rq_no" name="rq_no" readonly value="<?php echo isset($rq_no) ? $rq_no : '' ?>">
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
						...
						<tbody>
							...
							<tr class="po-item" data-id="">
								...
								<td class="align-middle p-1">
									...
									<input type="text" class="text-center w-100 border-0 item_id" readonly value="<?php echo $row['name'] ?>" required/>
								</td>
